...
?>
      ...
      <tr>
         <td><img class="img" src="<?php echo $arr['movie_pic'];?>" alt="" /></td>
         <td><?php echo $arr['movie_name']; ?></td>
         <td><?php echo $arr['movie_date']; ?></td>
         <td><?php echo $arr['movie_time']; ?></td>
         <td><?php echo $arr['ticket_price']; ?></td>
         <td><a href="<?php echo $arr['movie_trailer'];?>">Trailer</a></td>
         <td><?php echo $arr['movie_cinema']; ?></td>
         <td><a href="update_movie.php?movie_id=<?php echo $arr['movie_id']; ?>&email=<?php echo $_GET['email'] ?>"><i class='fa fa-repeat' style='font-size:24px;color:green'></i></a></td>
         <td><a href="delete_movie.php?movie_id=<?php echo $arr['movie_id']; ?>&email=<?php echo $_GET['email'] ?>"><i class='fa fa-trash' style='font-size:24px;color:darkred'></i></a></td>
