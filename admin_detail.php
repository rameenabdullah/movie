...
<tr>
    ...
    <td><a href="update_admin.php?admin_id=<?php echo $arr['admin_id']; ?>&email=<?php echo $_GET['email'] ?>"><i class='fa fa-repeat' style='font-size:24px;color:green'></i></a></td>
    <td><a href="delete_admin.php?admin_id=<?php echo $arr['admin_id']; ?>&email=<?php echo $_GET['email'] ?>"><i class='fa fa-trash' style='font-size:24px;color:darkred'></i></a></td>
    </tr>
  </tbody>
