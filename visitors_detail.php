...
<div class="table-users">
   <div class="header">Visitor Detail</div>
   <thead>
   <table cellspacing="0">
      <tr>
         <th>Visitors ID</th>
...
?>
      ...
      <tr>
         <td><?php echo $arr['visitors_id']; ?></td>
         <td><?php echo $arr['visitors_name']; ?></td>
         <td><?php echo $arr['visitors_email']; ?></td>
         <td><?php echo $arr['visitors_number']; ?></td>
         <td><?php echo $arr['visitors_password']; ?></td>
         <td><a href="update_visitors.php?visitors_id=<?php echo $arr['visitors_id']; ?>&email=<?php echo $_GET['email'] ?>"><i class='fa fa-repeat' style='font-size:24px;color:green'></i></a></td>
         <td><a href="delete_visitors.php?visitors_id=<?php echo $arr['visitors_id']; ?>&email=<?php echo $_GET['email'] ?>"><i class='fa fa-trash' style='font-size:24px;color:darkred'></i></a></td>
