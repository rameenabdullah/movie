...
<div class="container">
  <div class="left">
    <div class="header">
      <h2 class="animation a1">Update Admin</h2>
      <br>
      <br>
    </div> 
      <form class="form" action="" method="post" enctype="multipart/form-data">
      <input type="text" name="admin_name" class="form-field animation a4" value="<?php echo $data1['admin_name'] ?>" placeholder="Name">
      <br>
      <input type="email" name="admin_email" class="form-field animation a3" placeholder="email" value="<?php echo $data1['admin_email'] ?>" >
      <br>
      <input type="password" name="admin_password" class="form-field animation a4" placeholder="password" value="<?php echo $data1['admin_password'] ?>">
      <br>
      <br>
      <button class="animation a6" name="save">Save Changes</button>
    </form>
  </div>
</div>
</center>
