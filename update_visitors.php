...
$sql = "SELECT * from visitors where visitors_id='$visitors_id'";
...
if(isset($_POST['save'])){
    ...
    $visitors_password = $_POST['visitors_password'];
        ...
        $sql = "UPDATE visitors SET visitors_name ='$visitors_name ',visitors_email='$visitors_email', visitors_number=' $visitors_number', visitors_password=' $visitors_password' where visitors_id = '$visitors_id'";
...
<div class="container">
  <div class="left">
    <div class="header">
      <h2 class="animation a1">Update visitors</h2>
    </div> 
      <form class="form" action="" method="post" enctype="multipart/form-data">
      <input type="text" name="visitors_name" class="form-field animation a4" placeholder="Name" value="<?php echo $data1['visitors_name'] ?>" >
      <input type="email" name="visitors_email" class="form-field animation a3" placeholder="email" value="<?php echo $data1['visitors_email'] ?>">
      <input type="number" name="visitors_number" class="form-field animation a4" placeholder="phone" value="<?php echo $data1['visitors_number'] ?>" >
      <input type="password" name="visitors_password" class="form-field animation a3" placeholder="password" value="<?php echo $data1['visitors_password'] ?>">
      <br>
