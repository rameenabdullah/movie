...
<div class="container">
  <div class="left">
    <div class="header">
      ...
      <form class="form" action="movie_process.php?email=<?php echo $_GET['email']; ?>" method="post" enctype="multipart/form-data">
      <input type="text" name="movie_name" class="form-field animation a4" placeholder="Movie Name">
      <input type="text" name="movie_trailer" class="form-field animation a3" placeholder="Movie Trailer">
      <input type="number" name="ticket_price" class="form-field animation a4" placeholder="Ticket Price">
      <input type="date" name="movie_date" class="form-field animation a3" placeholder="Movie Date">
      <input type="file" name="movie_pic" class="form-field animation a4" placeholder="Movie Pic">
      <input type="time" name="movie_time" class="form-field animation a3" placeholder="Movie Time">
      <input type="text" name="movie_cinema" class="form-field animation a3" placeholder="Cinema">
      <br>
      <button class="animation a6" name="save" >Upload</button>
    </form>
  </div>
